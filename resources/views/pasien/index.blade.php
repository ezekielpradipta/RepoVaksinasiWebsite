...
@section('title', 'Data Pasien Vaksinasi ')

@section('menu_pagina')
@section('content')
<div class="box box-primary">
    <div class="box-header">
        <h3 class="box-title">Data Pasien Vaksinasi</h3>
    </div>
    <div class=" box-body">
                ...
                <form method="post" id="form" name="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik"
                            placeholder="Nomor NIK KTP" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nohp') is-invalid @enderror" id="nohp"
                            name="nohp" placeholder="Nomor Handphone/Whatsapp">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nohp') is-invalid @enderror" id="vaksin_id"
                            name="vaksin_id" placeholder="vaksin_id" readonly>
...
<script>
    $(document).ready( function () {
            ...
            $('body').on('click', '.editItem', function () {
                ...
                var url = "{{route('pasien.index')}}".concat("/" + pasien_id +"/edit");
                console.log(url);
                jQuery.ajax({
                     url :  url,
                     type : "GET",
                     ...
                     success:function(data)
                     {
                        ...
                        $('#nohp').val(data.nohp);
                        $('#vaksin_id').val(data.vaksin.vaksin_nama );
