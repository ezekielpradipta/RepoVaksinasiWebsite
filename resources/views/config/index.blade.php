                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group {{ $errors->has('app_name') ? 'has-error' : '' }}">
                                <label for="nome">Nama Aplikasi</label>
                        ...
                        <div class="col-lg-7">
                            <div class="form-group {{ $errors->has('app_slogan') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="app_slogan" class="form-control" maxlength="70"
                                    placeholder="App Slogan" value="{{$config->app_slogan}}">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group {{ $errors->has('tamanho_img_login') ? 'has-error' : '' }}">
                                ...
                                <input type="number" name="tamanho_img_login" class="form-control"
                                    value="{{$config->tamanho_img_login}}">
